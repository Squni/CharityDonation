    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            document.querySelectorAll(".category-box").forEach(el => {
                if (el.checked == true) {
                    const categoryName = document.querySelector(`#desc${el.value}`).innerText;
                    category.push(" " + categoryName);
                }
            });
            let institution;
            document.querySelectorAll(".institution").forEach(el => {
                if (el.checked) {
                    institution = document.querySelector(`#inst${el.value}`).innerText;
                }
            });
            ...
            let summaryBagsCategory = document.querySelector("#summary-bags-category");
            ...
            let summaryDate = document.querySelector("#summary-date");
            let summaryTime = document.querySelector("#summary-time");
            let summaryComment = document.querySelector("#summary-comment");


            summaryBagsCategory.innerText = bags + " worki " + category;
            summaryInstitution.innerText = "Dla " + institution;
            summaryStreet.innerText = street;
