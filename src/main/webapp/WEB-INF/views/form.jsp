        ...
        <form:form modelAttribute="donation" action="/app/form-confirm" method="post">
            ...
            <div data-step="1" class="active">
                ...
                <c:forEach items="${categories}" var="cat">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <input type="checkbox" name="categories" value="${cat.id}" class="category-box"/>
                            <span class="checkbox"></span>
                            <span class="description" id="desc${cat.id}">${cat.name}</span>
                        </label>
                    </div>
                </c:forEach>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input type="number" name="bags" path="quantity" step="1" min="1" id="bags"/>
                    </label>
                </div>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Numer telefonu <form:input path="phoneNumber" id="phone"/>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="summary-bags-category">4 worki ubrań w dobrym stanie dla dzieci</span>
                            </li>
